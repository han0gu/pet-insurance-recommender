...
chunk = Document(
    page_content=('가) 척추(등뼈)의 골절 또는 탈구로 35° 이상의 척추전만증(척추가 앞으로 휘 어지는 증상), 척추후만증(척추가 뒤로 휘어지는 증상) '
 '또는 20° 이상의 척추측만증(척추가 옆으로 휘어지는 증상) 변형이 있을 때 나) 척추체(척추뼈 몸통) 한 개의 압박률이 60%이상인 '
 '경우 또는 한 운동단위\n'
