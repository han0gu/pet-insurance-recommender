...
chunk = Document(
    page_content=('① 피보험자는 다음의 서류를 제출하고 보험금을 청구하여야 합니다.\n'
 ...
 '내역서(진료항목이 기재되어 있는 명세서, 수의사 처방전 포함) 및 의료비 영수증 등)\n'
 '가. 자기공명영상(MRI) 또는 컴퓨터단층촬영(CT) 촬영 확인이 가능한 동물병원 진 료기록부 혹은 의료비 영수증'),
