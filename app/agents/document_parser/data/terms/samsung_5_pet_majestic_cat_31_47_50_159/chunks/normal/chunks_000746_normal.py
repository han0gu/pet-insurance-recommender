...
chunk = Document(
    page_content=('⑤ 제4항의 「자기부담금」 이란 보험증권에 기재된 4-1. 반려묘 의료비(치과및구강질환 포함)(재가입형) 특별약관의 자기부담금을 말합니다 '
 '⑥ 제1항의 「연간」이란 계약일로부터 매1년 단위로 도래하는 계약해당일 전일까지의 기간을 의미합니다. ⑦ 제2항에도 불구하고 4-1. '
 '반려묘 의료비(치과및구강질환포함)(재가입형) 특별약관 제 27조 (특별약관의 재가입에 관한 사항) 제1항 및 제2항에 따라 재가입하는 '
 '경우 또는 4-1'),
