...
chunk = Document(
    page_content=('③ 제1항의 손해에 대한 보장개시일(책임개시일)은 이 특별약관의 보험계약일(이하 「보 험계약일」 이라 합니다)부터 그 날을 포함하여 '
 '30일(단, 암, 백내장, 녹내장, 심장질환 , 신장질환, 방광질환 및 각종 결석의 경우 90일)이 지난 날의 다음날로 합니다. 다만, '
 '상해를 직접적인 원인으로 치료를 받은 경우에는 보험계약일을 보장개시일(책임개시 일)로 합니다. 이 경우 보험계약일은 이 특별약관의 제1회 '
 '보험료를 받은 날로 합니다\n'
 '<예시안내>'),
