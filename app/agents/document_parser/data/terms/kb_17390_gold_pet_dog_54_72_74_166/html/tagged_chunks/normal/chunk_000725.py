...
chunk = Document(
    page_content=('피보험자가 정당한 이유없이 입원기간 중 의사의 지시를 따르지 않은 때에는 회<br>사는 질병입원일당의 전부 또는 일부를 지급하지 '
 '않습니다.<br>\uf000 피보험자가 병원 또는 의원을 이전하여 입원한 경우에도 동일한 질병의 치료를<br>목적으로 2회이상 입원한 '
