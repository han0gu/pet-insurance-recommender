...
MOCK_RAG_CHUNKS: list[RagChunkResult] = [
    {
        ...
        "query_tokens": ["다리", "부상", "피부병", "심장", "판막증", "치과", "질환", "보장", "범위", "수술", "이력", "없", "경우", "적용", "가능", "보험", "약관"],
        "matched_vocab_tokens": ["부상", "피부병", "심장", "치과", "질환", "보장", "범위", "수술", "없", "경우", "적용", "가능", "보험", "약관"],
    ...
    },
    {
        ...
        "query_tokens": ["다리", "부상", "피부병", "심장", "판막증", "치과", "질환", "보장", "범위", "수술", "이력", "없", "경우", "적용", "가능", "보험", "약관"],
        "matched_vocab_tokens": ["부상", "치과", "질환", "보장", "범위", "수술", "없", "경우", "적용", "가능", "보험", "약관"],
...
def get_mock_policies() -> list[str]:
    """Mock 약관 텍스트(chunk_content) 리스트를 반환합니다.

    RAG 담당자 양식의 chunk_content만 추출하여, 현재 평가 파이프라인( Judge/Evaluator 의
    policy_text 입력)과 호환되도록 합니다. 실제 RAG 연동 시에는 RAG 응답에서 chunk_content
    를 꺼내 이와 동일한 형태로 넘기면 됩니다.
    """
